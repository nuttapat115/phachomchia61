                            ...
                            <div class="row">
                                <div class="col-md">
                                    <nav id="fullsized_image_holder">
                                        ...
                                        <img src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->merge('https://raw.githubusercontent.com/nuttapat115/phachomchia61/master/web/web%20phachomchia61/public/img/qttestlogo2.jpg', .0, true)->errorCorrection('H')->size(300)->generate(Auth::user()->studentID )) !!} " class="qrlogo">
