                            ...
                            <div class="row">
                                <div class="col-md">
                                    <nav id="fullsized_image_holder">
                                        ...
                                        <img src="data:image/png;base64, <?php echo base64_encode(QrCode::format('png')->merge('https://raw.githubusercontent.com/nuttapat115/phachomchia61/master/web/web%20phachomchia61/public/img/qttestlogo2.jpg', .0, true)->errorCorrection('H')->size(500)->generate(Auth::user()->studentID )); ?> " class="qrlogo">
                                        ...
                                        <nav style="margin: 10px 0px">
                                            <div class="row">
                                                <div class="col-md" style="margin: 5px 0px">
                                                    <button type = "button" class = "btn btn-secondary" style="width: 100%;border-radius: 20px" onclick="window.location.href = '<?php echo e(route('stage')); ?>'">View your seat</button>
                                                </div>
                                                <div class="col-md" style="margin: 5px 0px">
