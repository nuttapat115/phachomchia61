...
class AuthController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        if (Auth::guard('admin')->attempt(['studentID' => $request->studentID, 'password' => $request->password , 'LoginStatus' => '0'], $request->remember)) {
            DB::table('admins')
        ...
        Alert::error('เข้าสู่ระบบไม่สำเร็จ', 'โปรดเชคว่ามีการเข้าใช้ซ้ำหรือป่าว !!!');
